...
\begin{frame}{Microservices Architecture}
    \begin{itemize}
        ...
        \item Jetzt: fein granuliertere, vollständig isolierte Services
...
\begin{frame}{Microservices Architecture: Beispiel E-Commerce I}
    \begin{itemize}
        ...
        \item Unabhängige Services für Bestellung, Bezahlung, Versand
...
\begin{frame}{Microservices Architecture: Agilität}
    \begin{itemize}
        ...
        \item Aber: Aufwendige Integrationstest durch hohe Anzahl an Komponenten
