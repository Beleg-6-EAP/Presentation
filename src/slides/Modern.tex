...
\begin{frame}{Microservices + Layered Architecture: Beispiel E-Commerce}
    \begin{figure}[!h]
        \centering
...
\begin{frame}{Layered Architecture: Agilität}
    \begin{itemize}
        ...
        \item Schichten sind lose gekoppelt $\Rightarrow$ Einfache Einführung neue Schichten $\Rightarrow$ Einfache Skalierung
        \item Klare Trennung $\Rightarrow$ Bessere Testbarkeit, Wartbarkeit und Organisation $\Rightarrow$ Schnelle Auslieferung
        \item Funktionalitäten wiederverwendbar in mehreren Schichten $\Rightarrow$ Keine Duplikation von Code $\Rightarrow$ Auslieferung in kurzen Intervallen
        \item Änderungen in einer Schicht wirken sich nicht auf das gesamte System $\Rightarrow$ Schnelle Reaktion auf Änderungen
        \item Exzellente Kombination mit Microservices
    \end{itemize}
\end{frame}
